"""
Refernce: https://github.com/omihub777/ViT-CIFAR
"""
...
class ViT(nn.Module):
    def __init__(self, in_c:int=3, num_classes:int=10, img_size:int=32, patch:int=8, dropout:float=0., num_layers:int=7, hidden:int=384, mlp_hidden:int=384*4, head:int=12, is_cls_token:bool=True):
...
#     out = net(x)
#     print(out['penultimate'].shape, out['final'].shape)
#
#     # out.mean().backward()
#     # print(out.shape)
#
